...
class LinearRegression extends Component {
    ...
    render() {
        return(
            <body style={{ background: "#CFF9F0", padding: "90px" , float:"left"}}>
                <h2 style={{color: "#003a8c", fontWeight: "bold",fontSize: "50px",textAlign:"center"}}>Linear Regression</h2>
                <div style={{textAlign:"center"}}>
                    <Card
                      bordered={true}
                      style={{ width: "100%" ,height:600, background: "#FFFFFF", color: "#FFFFFFFF", float:"Auto"}}
