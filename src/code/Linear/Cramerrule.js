...
class Cramerrule extends Component {
    constructor() {
        ...
        this.state = {
            ...
            showDimentionButton: true, //Submit
            showMatrixForm: false, //matrix
            showMatrixButton: false, //submit
    ...
    render() {
        return (
            <Router>
                <Layout>
                    <body
                        style={{ background: "#CFF9F0", padding: "90px" , float:"left" }}
                        onChange={this.handleChange}
                    >
                     <h2 style={{color: "#003a8c", fontWeight: "bold",fontSize: "50px",textAlign:"center"}}>Cramer's rule</h2>
                        {/*-----------------------------------------ปุ่มINPUTสมการ----------------------------------------------------*/}
                        <Row gutter={[40, 40]}
                            bordered={true}
                            onChange={this.handleChange}
